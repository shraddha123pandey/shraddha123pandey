...
{
	PrioritySchedulingAlgorithm ob=new PrioritySchedulingAlgorithm();
	int n = 5;
	Process proc[] = new Process[n];
	proc[0] = new Process(1, 10, 3);
	proc[1] = new Process(2, 1, 1);
	proc[2] = new Process(3, 2, 3);
	proc[3] = new Process(4, 1, 4);
	proc[4] = new Process(5, 5, 2);

	ob.priorityScheduling(proc, n);
	// burst time= 10,1,2,1,5, Arrival time =0 , 
	//priority=3,1,3,4,2 
}
}
